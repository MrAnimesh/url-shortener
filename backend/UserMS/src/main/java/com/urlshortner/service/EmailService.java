...
public class EmailService {
	...
	public void sendVerificationEmailToWorker(String toEmail, String verificationToken) {
			...
			String emailContent = """
				...
				<body>
				    <div class="container">
						...
						<p>An administrator created a worker account for you. Please verify your email address before signing in.</p>
				        ...
				        <p>If this is not for you, please ignore this email or contact our support team if you have concerns.</p>
